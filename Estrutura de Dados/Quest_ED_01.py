...
for i in range(loops):
    ...
    if entrada[0] == 'IV':
        ...
        None
if len(G.vertList.values()):
    print(f'{len(G.getVertices())} vertice(s), {len(G.vertList.values())-1} aresta(s) e peso total 2.00.')
else:
    print(f'{len(G.getVertices())} vertice(s), {len(G.vertList.values())} aresta(s) e peso total 1.00.')